      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="glass-card p-5 space-y-4">
          ...
          <div>
            ...
            <select className="bg-[rgba(255,255,255,0.06)] border border-white/[0.12] text-white rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500/50 w-full" value={form.timezone} onChange={set('timezone')}>
