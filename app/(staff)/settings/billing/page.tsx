      ...
      <div className="glass-card p-6 space-y-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-xl font-bold text-slate-900 dark:text-white">Agency Plan</p>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Full access to all Stratiq features for your team.</p>
          </div>
        ...
        <hr className="border-slate-900/10 dark:border-white/[0.08]" />

        {/* Managed externally notice */}
        <div className="rounded-xl bg-slate-900/[0.04] dark:bg-white/[0.04] border border-slate-900/10 dark:border-white/[0.07] p-4 text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
