      ...
      <div className="w-full max-w-md animate-float-up">
        ...
        <div className="glass rounded-3xl p-8">
          {sent ? (
            ...
            <>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Request access</h2>
              <p className="text-slate-600 dark:text-slate-400 text-sm mb-8">Fill out the form and your admin will create your account.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider">Full name <span className="text-red-400">*</span></label>
                  <input type="text" required className="input-glass" placeholder="Jane Smith"
                    value={form.name} onChange={set('name')} />
                </div>
                <div>
                  <label className="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider">Work email <span className="text-red-400">*</span></label>
                  <input type="email" required className="input-glass" placeholder="jane@mindshare.co"
                    value={form.email} onChange={set('email')} />
                </div>
                <div>
                  <label className="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider">Your role</label>
                  <select className="w-full bg-white dark:bg-[rgba(255,255,255,0.06)] border border-slate-900/10 dark:border-white/[0.12] text-slate-900 dark:text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500/50"
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider">Message <span className="text-slate-500 dark:text-slate-600">(optional)</span></label>
